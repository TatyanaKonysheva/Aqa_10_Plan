...
#### Подсценарий 1: Ввод валидных значений
   ...
   1. Клик по кнопке "Записаться".
   #### Подсценарий 5: Отправка формы с невалидеым значением имени
   1. Ввод невалидных данных в поле Имя:
      * Цифр. Например: "1".
      * Наличие пробела. Например: "Ксюша Миша".
      * Имя из одной буквы. Например: "Ю".
      * Символов. Например:"В№ика".
   1. Ввод валидных данных в поле "Номер телефона" в формате +7-ххх-ххх-хх-хх. Например: "+7-919-93-11-11".
   1. Ввод валидных данных в поле "Электронная почта". Например: "ta_8@mail.ru"
   1. Клик по кнопке "Записаться".
   #### Подсценарий 6: Отправка формы с невалидеым значением номера телефона
   1. Ввод валидных данных в поле Имя. Например: "Мария"
   1. Ввод невалидных данных в поле "Номер телефона":
      * Ввод 1 цифрыю Например: "+7-1".
      * Ввод 9 цифр. Например: "+7-919-936-11-1".
      * Ввод 11 цифрю Например: "+7-919-999-11-111"
      * Ввод букв. Например: "+7-АаА".
      * Ввод символов. Напрмер: "+7-%%%-%%%-%%-%%"
   1. Ввод валидных данных в поле "Электронная почта". Например: "ta_8@mail.ru"
   1. Клик по кнопке "Записаться".
   #### Подсценарий 7: Отправка формы с невалидеым значением электронной почты
   1. Ввод валидных данных в поле Имя. Например: "Мария"
   1. Ввод валидных данных в поле "Номер телефона" в формате +7-ххх-ххх-хх-хх. Например: "+7-919-93-11-11".
   1. Ввод невалидных данных в поле "Электронная почта":
      * Ввод email без точек в доменной части. Например: "ta_8@mailru".
      * Ввод email без @. Например: "ta_8mail.ru"
      * Ввод Email с пробелами в имени пользователя. Например: "ta  _8@mail.ru"
      * Ввод Email с пробелами в доменной части. Например: "ta_8@ma   il.ru"
      * Ввод Email без имени пользователя. Например: "@mail.ru"
      * Ввод Email без доменной части. Например: "ta_8@"
   1. Клик по кнопке "Записаться".
