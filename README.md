...
<details>
   ...
   1. Клик по кнопке "Записаться".
      ...
      *Ожидаемый результат:* сообщение об успешной записи на курс и информацией о способах оплаты.
</details>
...
<details>
   ...
   1. Клик по кнопке "Записаться".
      ...
      *Ожидаемый результат:* сообщение, что поле обязательно для заполнения.
 </details>
   ...
   1. Клик по кнопке "Записаться".
      ...
      *Ожидаемый результат:* сообщение "Должно содержать не менее 2ух букв".
    </details>
   ...
   1. Клик по кнопке "Записаться".
      ...
      *Ожидаемый результат:* нет возможности ввода 11-тицифр, сообщение "Номер в формате +9 (999) 999-99-99".
   </details>
